    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Thông tin không thay đổi (Họ tên, ngày sinh, giới tính...)", "Định danh cá nhân", "Cố định" },
                    { 2, "Thông tin pháp lý (CMND/CCCD, hộ chiếu...)", "Pháp lý", "Ít thay đổi" },
                    { 3, "Thông tin bảo hiểm, thẻ ưu đãi...", "BHYT & Quyền lợi", "Thay đổi định kỳ" },
                    { 4, "Gen, nhóm máu, dị ứng bẩm sinh, bệnh nền...", "Di truyền bất biến", "Bất biến" },
                    { 5, "Chỉ số sinh tồn, xét nghiệm, kết quả khám...", "Sinh học biến động", "Biến động liên tục" }
                });
